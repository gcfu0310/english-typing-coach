...
- `content.js` and `popup.js` print no errors.
...
3. Click `Translate`.
4. The `Suggested English` area shows:

```text
I want to check whether this design makes sense.
```

5. Click `Insert English`.
6. The mock input box changes to:
...
- Translation is still mocked; no real model API is connected yet.
